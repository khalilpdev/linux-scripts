> **Deprecated:** this note is kept only as historical context. The NVIDIA 390xx flow was discarded in this repository because it could force boot/session through NVIDIA and break the desktop. Use `shell-version/nvidia/restore-intel-x11.sh` instead.
